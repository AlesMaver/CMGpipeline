...
workflow FastqToVCF {
  ...
  if ( defined(input_cram) ) {
    call CramConversions.CramToBam as Cram_hg19_ToBam {
      input:
  ...
  if ( defined(input_cram_hg38) ) {
    call CramConversions.CramToBam as Cram_hg38_ToBam {
      input:
